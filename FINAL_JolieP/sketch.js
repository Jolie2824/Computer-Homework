...
function homescreen() 
{
  ...
  fill(0);
  textSize(46);
  text("Cow Invaders", width/1.5, height/2.5);
  textSize(34);
  fill(255);
  stroke(0,0,0,100);
  strokeWeight(4);
  text("Click to start", width/1.6, height/2);
}
...
//cow
image (cow, width - width / 1, height - height / 3.2, cow.width / 2, cow.height / 2.5); //try to switch this over instead of the circle
